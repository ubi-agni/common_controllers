...
void MassTest::updateHook() {
	...
	if(joint_position_.size() != number_of_joints_) {
		RTT::log(RTT::Error) << "Received joint position vector have invalid size. [read: " << joint_position_.size() << " expected: " << number_of_joints_ << "]" << RTT::endlog();
		error();
	}
	...
	std::cout << M_.block<7, 7>(2, 2) << std::endl << std::endl;
	std::cout << Mr_ << std::endl << std::endl;
	std::cout << M_.block<7, 7>(2, 2) - Mr_<< std::endl << std::endl;
	std::cout << "--------------------------------------------"<< std::endl;
	
	std::cout << "left:" << std::endl;
	std::cout << M_.block<7, 7>(9, 9) << std::endl << std::endl;
	std::cout << Ml_ << std::endl << std::endl;
	std::cout << M_.block<7, 7>(9, 9) - Ml_<< std::endl << std::endl;
	std::cout << "--------------------------------------------"<< std::endl;
	*/
